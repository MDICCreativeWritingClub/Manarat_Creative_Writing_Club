            ...
            <div className="max-w-3xl flex flex-col gap-6">
              ...
              <div className="rounded-xl border p-5" style={{ borderColor: colors.gray200, backgroundColor: colors.surface }}>
                ...
                <div className="grid sm:grid-cols-2 gap-4 mb-4">
                  <div className="rounded-lg p-3" style={{ backgroundColor: colors.badgeBg }}>
                ...
                <div className="flex gap-3 items-end">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-5 py-2.5 rounded-xl text-white text-sm hover:opacity-90 transition-all active:scale-95 shrink-0"
