...
export function ArticlePage({ id }: { id: string }) {
  ...
  return (
    <article className="max-w-3xl mx-auto px-5 pt-24 pb-24">
      ...
      <div className="flex items-center gap-4 pb-7 mb-12 border-b" style={{ borderColor: colors.gray200 }}>
        <div
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-full text-sm shrink-0 transition-all active:scale-95"
          style={{
