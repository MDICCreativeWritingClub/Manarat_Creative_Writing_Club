...
export function AuthorSearch() {
  ...
  return (
    <div className="max-w-5xl sm:max-w-2xl lg:max-w-4xl xl:max-w-5xl mx-auto px-5 pt-28 pb-20 transition-all">
      <h1
      ...
      <form onSubmit={handleSearch} className="flex gap-2 mb-8">
        ...
        <button
          type="submit"
          disabled={searching}
          className="flex items-center gap-1.5 px-5 py-2.5 rounded-xl text-white text-sm hover:opacity-90 transition-opacity disabled:opacity-60"
