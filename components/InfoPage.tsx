...
import { ArrowLeft, Upload, Star, BookOpen, Shield, ChevronDown } from "lucide-react";
...
export function InfoPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-5 pt-28 pb-20">
      <Link
        href="/"
        className="inline-flex items-center gap-1.5 text-sm mb-10 hover:gap-2.5 transition-all"
